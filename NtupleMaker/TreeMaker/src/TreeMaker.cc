...
// Class:      TreeMaker
// 
/**\class TreeMaker TreeMaker.cc SusyAnaTools/TreeMaker/plugins/TreeMaker.cc
 * 
...
//
//
#include "SusyAnaTools/StopTreeMaker/interface/TreeMaker.h"
...
TString TreeMaker::formBranchName(const edm::InputTag & varTag, const std::vector<std::string> & vectorNames){
